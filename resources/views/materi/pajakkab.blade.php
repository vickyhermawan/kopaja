                    ...
                    <div class="learning_member_text">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-12 col-lg-4">
                                <div class="learning_member_text_iner">
                                    <span class="ti-pencil-alt"></span>
                                    <a href="{{Route('latsoalpajakkab')}}"><h4>Contoh Soal Pajak</h4></a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 course_details_left">
                    <div class="content_wrapper">Jenis-Jenis Pajak Kabupaten/Kota Cara Menghitung PPh Pasal 25 Untuk Wajib Pajak Baru </h4>
                        <div class="content">
